...
Credentials are encrypted with Windows DPAPI in the `CurrentUser` scope or
stored in the current user's macOS Keychain. The bridge intentionally rejects
group chats, unpaired users, oversized images,
